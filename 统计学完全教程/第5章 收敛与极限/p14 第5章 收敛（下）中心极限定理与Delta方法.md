...
> **参考来源**：课本第 5 章 5.4–5.5 节（中心极限定理、Delta 方法）；**18.600 讲义 Lecture 31**（本地 `原始材料\MIT18.600\Lecture31.pdf`：中心极限定理；Delta 方法不在 18.600 范围）；18.650 视频无对应集；B站可看替代 **6.041SC**（BV1sL411V7da）第 20 集（中心极限定理）；补充讲义 CMU 36-705 Lec6（随机阶记号、Lyapunov CLT）。
