...
-   [Hello, World!](../编程语言/helloworld.md)
-   [C++ 语法基础](../编程语言/basic.md)
...
-   [函数](../编程语言/func.md)
-   [递归 & 分治](../算法基础/divide-and-conquer.md)
...
-   [排序简介](../算法基础/sort-intro.md)
-   [选择排序](../算法基础/selection-sort.md)
-   [冒泡排序](../算法基础/bubble-sort.md)
-   [插入排序](../算法基础/insertion-sort.md)
-   [计数排序](../算法基础/counting-sort.md)
-   [基数排序](../算法基础/radix-sort.md)
-   [快速排序](../算法基础/quick-sort.md)
-   [归并排序](../算法基础/merge-sort.md)
-   [堆排序](../算法基础/heap-sort.md)
-   [桶排序](../算法基础/bucket-sort.md)
-   [排序相关 STL](../算法基础/stl-sort.md)
...
-   [栈](../数据结构/stack.md)
-   [队列](../数据结构/queue.md)
-   [链表](../数据结构/linked-list.md)

#### 2.7.2 复杂数据结构

-   [树及二叉树](../图论/tree-basic.md)
-   [图的概念](../图论/concept.md)
-   [图的存储](../图论/save.md)
...
-   [数论基础](../数学/number-theory/basic.md)
-   [素数](../数学/number-theory/prime.md)
-   [筛法](../数学/number-theory/sieve.md)
-   [最大公因数](../数学/number-theory/gcd.md)
-   [欧拉函数](../数学/number-theory/euler-totient.md)
-   [分解质因数](../数学/number-theory/pollard-rho.md)

#### 2.9.5 组合计数

-   [排列组合](../数学/combinatorics/combination.md)
-   [抽屉原理](../数学/combinatorics/drawer-principle.md)
-   [容斥原理](../数学/combinatorics/inclusion-exclusion-principle.md)
