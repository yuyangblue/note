...
具体可参见 [循环展开 (Loop Unroll)](../编程语言/编译器优化.md#循环展开-loop-unroll)、[代码布局优化 (Code Layout Optimizations)](../编程语言/编译器优化.md#代码布局优化-code-layout-optimizations) 等内容
...
> 
具体而言，对拍需要一个 [数据生成器](../工具/testlib/generator生成器.md) 和两个要进行输出结果比对的程序．
> 
