...
IDE 操作较为简单，一般入门玩家会选用 IDE 来编写代码．在竞赛中最常见的是 [Dev-C++](../工具/editor/DevC++.md)（如果考试环境是 Windows 系统，一般也会提供这一 IDE）．
...
注意：C 语言在这里仅做参考，C++ 基本兼容 C 语言，并且拥有许多新的功能，可以让选手在赛场上事半功倍．具体请见 [C++ 与其他常用语言区别](./C++与其他语言.md)
