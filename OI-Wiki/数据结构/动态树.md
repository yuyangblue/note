...
下面是 Splay 树中用到的函数，具体可以查阅 [Splay 树](./Splay树.md)．
...
1.  splay
    ...
    由 [Splay 的时间复杂度](./Splay树.md#时间复杂度) 分析易知，splay 操作的均摊时间复杂度为 $O(\log n)$．

2.  访问虚边

    参考 [重链剖分](../图论/树链剖分.md#重链剖分)，定义两种虚边：
