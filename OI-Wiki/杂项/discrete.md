...
离散化是一种数据处理的技巧，本质上可以看成是一种 [哈希](../字符串/hash.md#hash-的思想)，其保证数据在哈希以后仍然保持原来的 [全/偏序](../数学/order-theory.md#偏序集) 关系．
...
参考实现中使用的 STL 算法可参考 [STL 算法](../编程语言/csl/algorithm.md)．

同样地，我们也可以对 [std::vector](../编程语言/csl/sequence-container.md#vector) 进行离散化：
