...
前置知识：[随机函数](../杂项/random.md) 和 [概率初步](../数学/probability/basic-conception.md)
...
详见 [随机增量法](../计算几何/random-incremental.md)．
...
-   保证算法过程中进行的「操作」具有（某种意义上的）均匀性．例如 [模拟退火](../杂项/simulated-annealing.md) 算法．
...
详见 [概率不等式](../数学/probability/concentration-inequality.md) 页面．
