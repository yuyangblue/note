...
\node[min node] (b6) at (9,1) { \color{red} L };
...
\node[above=0cm of b6.north,anchor=south west] (active2) {\small $\begin{aligned}&\alpha=3\\[-4pt]&\redcancel{\beta=+\infty}\end{aligned}$};
\node[above=-7pt of active1.north] {\small\color{red} $\alpha=3$};
\node[below=-10pt of active2.south] {\small\color{red} $\beta=3$};
