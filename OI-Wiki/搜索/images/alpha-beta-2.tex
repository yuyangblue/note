...
\node[min node] (b1) at (0.5,1) { \color{red} A };
\node[min node] (b2) at (2.5,1) {};
...
\node[left=0cm of c1.west] {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[left=0cm of b1.west] (active) {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\redcancel{\beta=+\infty}\end{aligned}$};
