...
\node[min node] (d2) at (9.375,3) { $2$ };

\node[max node] (e1) at (6.25,4) { $3$ };
...
\node[left=0cm of e1.west] {\small $\begin{aligned}&\alpha=3\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[left=0cm of d1.west] {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\beta=3\end{aligned}$};
\node[left=0cm of d2.west] {\small $\begin{aligned}&\alpha=3\\[-4pt]&\beta=3\end{aligned}$};
