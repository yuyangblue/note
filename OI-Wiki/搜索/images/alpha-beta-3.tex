...
\node[min node] (b2) at (2.5,1) { \color{red} C };
\node[min node] (b3) at (4,1) {};
\node[min node] (b4) at (5.5,1) {};
\node[min node] (b5) at (7.5,1) {};
\node[min node] (b6) at (9,1) {};
\node[min node] (b7) at (10.5,1) {};

\node[max node] (c1) at (1.5,2) { \color{red} B };
\node[max node] (c2) at (4.75,2) {};
\node[max node] (c3) at (8.25,2) {};
\node[max node] (c4) at (10.5,2) {};

\node[min node] (d1) at (3.125,3) {};
...
\node[left=0cm of d1.west] {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[left=0cm of c1.west] (active) {\small $\begin{aligned}&\redcancel{\alpha=-\infty}\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[left=0cm of b1.west] {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\beta=3\end{aligned}$};
\node[left=0cm of b2.west] {\small $\begin{aligned}&\alpha=3\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[above=-7pt of active.north] {\small\color{red} $\alpha=3$};
