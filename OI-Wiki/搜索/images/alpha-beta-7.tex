...
\node[left=0cm of e1.west] (active) {\small $\begin{aligned}&\redcancel{\alpha=-\infty}\\[-4pt]&\beta=+\infty\end{aligned}$};
\node[left=0cm of d1.west] {\small $\begin{aligned}&\alpha=-\infty\\[-4pt]&\beta=3\end{aligned}$};
\node[left=0cm of d2.west] {\small $\begin{aligned}&\alpha=3\\[-4pt]&\beta=+\infty\end{aligned}$};
...
\node[left=0cm of b5.west] {\small $\begin{aligned}&\alpha=3\\[-4pt]&\beta=+\infty\end{aligned}$};
