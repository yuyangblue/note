...
如果你不了解双端队列 `deque` 的话，请参阅 [deque 相关章节](../编程语言/csl/sequence-container.md#deque)．
...
优先队列，相当于一个二叉堆，STL 中提供了 [`std::priority_queue`](../编程语言/csl/container-adapter.md)，可以方便我们使用优先队列．
