...
字符串 $s$ 的 SAM 是一个接受 $s$ 的所有后缀的最小 [DFA](../杂项/fsm.md#确定性有限状态自动机)．
...
暂且接受这个事实，我们将基于它介绍构造 SAM 的算法．我们还将说明，SAM 需要满足的所有性质，除了最小性以外都满足了；而最小性可以由 [Myhill–Nerode 定理](../杂项/fsm.md#myhillnerode-定理) 得出．
