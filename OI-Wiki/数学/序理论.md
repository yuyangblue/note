...
> 
由于偏序具有反对称性，所以 Hasse 图一定是 [有向无环图](../图论/DAG.md)，进而我们可以根据 [拓扑排序](../图论/拓扑排序.md) 对任意有限偏序集构造全序．
> 
### 链与反链
> 
> [!note]- 定义
...
> > 
Dilworth 定理与 [Hall 婚配定理](../图论/graph-matching/图的匹配.md#hall-定理) 等价．
> > 
...
> > $$
> > 
> > 进而根据 Dilworth 定理有：**序列的不上升子序列的最少覆盖数等于最长上升子序列长度**．从而可以通过 [最长不下降子序列的 $O(n\log n)$ 做法](../动态规划/基础.md#算法二) 解决本题．
> > 
> > [!note]- 参考代码
> > ```cpp
...
## C++ 中的应用
> > 
另请参阅：[排序相关 STL -  算法基础](../算法基础/STL排序.md)．
> > 
