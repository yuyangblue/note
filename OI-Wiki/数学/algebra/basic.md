...
-   数据结构中，[线段树](../../数据结构/seg.md) 等结构可以维护幺半群的信息，而很多 DP 问题的递推关系可以抽象成这样的幺半群结构；
...
???+ note "思路分析"
    这道题是动态 DP 模板，一种复杂度正确的代码实现需要用到 [全局平衡二叉树](../../数据结构/global-bst.md)，具体样例代码也在对应页面．这里仅仅结合该题情景，分析建模的过程．
...
[^oi-wiki-not-wikipedia]: 因为 [OI Wiki 不是百科全书](../../简介/what-oi-wiki-is-not.md#oi-wiki-不是百科全书)．
