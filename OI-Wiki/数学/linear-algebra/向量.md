...
对于三维空间，向量旋转需要使用两个角度参量，即天顶角旋转角度与方向角旋转角度，可以利用 [空间球坐标系](../坐标系.md#空间球坐标系) 进行旋转操作．
...
上文中，向量被定义为了空间中的有向线段．但是严格来说，向量不仅是有向线段．要作出向量的更严格定义，需要先定义 [线性空间](./向量空间.md)，具体内容参见 [线性空间](./向量空间.md) 页面的介绍．
