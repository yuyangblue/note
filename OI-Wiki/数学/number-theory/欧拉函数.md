...
-   欧拉函数是 [积性函数](./基础.md#积性函数)．
    ...
    证明参见 [剩余系的复合](./基础.md#剩余系的复合)．

-   $n = \sum_{d \mid n}{\varphi(d)}$．

> [!note] 证明
> 利用 [莫比乌斯反演](./莫比乌斯反演.md) 相关知识可以得出．
> 
...
如果只要求一个数的欧拉函数值，那么直接根据定义质因数分解的同时求就好了．这个过程可以用 [Pollard Rho](./Pollard-Rho算法.md) 算法优化．
