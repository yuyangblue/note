...
即 Cayley 公式，参见 [Prüfer 序列](../../图论/prufer.md) 一文，我们也可以使用 [Kirchhoff 矩阵树定理](../../图论/matrix-tree.md) 或 [生成函数](../poly/intro.md#生成函数) 和 [拉格朗日定理](https://codeforces.com/blog/entry/104184) 得到这一结果．
