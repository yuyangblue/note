...
-   编写 [Generator](./generator生成器.md)，即数据生成器．
-   编写 [Validator](./validator验证器.md)，即数据校验器，判断生成数据是否符合题目要求，如数据范围、格式等．
-   编写 [Interactor](./interactor交互器.md)，即交互器，用于交互题．
-   编写 [Checker](./checker校验器.md)，即 [Special Judge](../SpecialJudge.md)．
