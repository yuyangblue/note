...
[^1]: [桶排序](../算法基础/桶排序.md) 以及 [主元素问题](../杂项/主元素问题.md#离线算法) 以及 [Stack Overflow 上对桶数据结构的讲解](https://stackoverflow.com/questions/42399355/what-is-a-bucket-or-double-bucket-data-structure)（英文）
