# 《概率论与数理统计》4.3 协方差与相关系数（p41-p42）

> 整理自 B 站《概率论与数理统计》教学视频 2.0 版本（up：宋浩老师官方）p41-p42。
...
![协方差正负](概率论与数理统计——宋浩/第4章%20随机变量的数字特征/figures/04-协方差正负.png)
...
![相关系数](概率论与数理统计——宋浩/第4章%20随机变量的数字特征/figures/04-相关系数.png)
